...
import com.min.projectboardadmin.dto.response.UserAccountClientResponse;
...
public class UserAccountManagementService {
    ...
    public List<UserAccountDto> getUserAccounts(){
        URI uri = UriComponentsBuilder.fromHttpUrl(projectProperties.getUrl() + "/api/userAccounts")
    ...
    public UserAccountDto getUserAccount(String userId){
        URI uri = UriComponentsBuilder.fromHttpUrl(projectProperties.getUrl() + "/api/userAccounts/" + userId)
                .build()
                .toUri();
