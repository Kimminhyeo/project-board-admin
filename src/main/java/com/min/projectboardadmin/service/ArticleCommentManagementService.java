...
public class ArticleCommentManagementService {
    ...
    public List<ArticleCommentDto> getArticleComments() {
        URI uri = UriComponentsBuilder.fromHttpUrl(projectProperties.getUrl() + "/api/articleComments")
    ...
    public ArticleCommentDto getArticleComment(Long articleCommentId) {
        URI uri = UriComponentsBuilder.fromHttpUrl(projectProperties.getUrl() + "/api/articleComments/" + articleCommentId)
